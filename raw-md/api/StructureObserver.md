...
<h2 id="observeRoom" class="api-property api-property--method  "><span class="api-property__name">observeRoom</span><span class="api-property__args">(roomName)</span>
        <div class="api-property__cpu api-property__cpu--A" title="这个方法是一个改变游戏状态的动作。在返回OK代码的情况下，它的自然成本增加了0.2个CPU成本。"></div>
        </h2>
...
<table><thead><tr><th>parameter</th><th>type</th><th>description</th></tr></thead><tbody>
<tr><td><code>roomName</code></td><td>string</td><td><p>目標房間名。</p>
</td>
</tbody></table>
...
<tr><td><code>ERR_NOT_IN_RANGE</code></td><td>-9</td><td><p>房間<code>roomName</code>不在觀察范圍內。</p>
</td></tr>
<tr><td><code>ERR_INVALID_ARGS</code></td><td>-10</td><td><p><code>roomName</code>參數不是一個有效的房間名。</p>
</td></tr>
